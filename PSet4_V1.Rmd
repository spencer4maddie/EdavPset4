...
ggplot(subset(df, Year>"2007"), aes(map_id = state)) + geom_map(aes(fill = `Crude Rate`), map = states_map, col = "white") +
  expand_limits(x = states_map$long, y = states_map$lat) + scale_fill_viridis_c(option = "viridis") +
  facet_wrap(~Year, ncol = 2 ) +
  labs(fill = "Death rate per \n 10,000 population ",
       title = "U.S. Death Rate per 10,000 population from 2008-2017", x = "longitude", y = "latitude",
